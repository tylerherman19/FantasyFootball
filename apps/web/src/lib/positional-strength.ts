...
/**
 * Computed on demand rather than memoized.
 *
 * It is one lineup solve per team against an already-loaded projection pool —
 * a few milliseconds — and the league it reads from is itself cached, so
